...
export interface CurriculumProgressHistoryPoint {at:string;solved:number;progress_percent:number}
export interface CurriculumProgressHistory {level:string;eligible:number;unlock_required:number;points:CurriculumProgressHistoryPoint[]}
