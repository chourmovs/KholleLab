...
FAMILIES = (
    ...
    Family("2de-algebra-factor", "Factoriser une expression", "seconde", "lycee-2019-2de-algebra", "factor", ("algebra",), ("calculation",), (2, 3)),
    Family("2de-algebra-inequality", "Résoudre une inéquation", "seconde", "lycee-2019-2de-algebra", "inequality", ("inequalities",), ("inequality-solving",), (2, 3)),
    Family("2de-function-image", "Calculer l’image par une fonction quadratique", "seconde", "lycee-2019-2de-functions", "quadratic_image", ("functions",), ("calculation",), (1, 3)),
    Family("2de-function-variation", "Étudier le minimum d’une fonction", "seconde", "lycee-2019-2de-functions", "vertex", ("functions",), ("reasoning",), (2, 4)),
    Family("2de-vector-midpoint", "Calculer les coordonnées d’un milieu", "seconde", "lycee-2019-2de-geometry", "midpoint", ("geometry",), ("calculation",), (1, 3)),
    Family("2de-probability-complement", "Calculer la probabilité d’un événement contraire", "seconde", "lycee-2019-2de-data", "probability", ("probability",), ("reasoning",), (1, 3)),
    Family("1re-algebra-sequence", "Calculer un terme d’une suite arithmétique", "premiere", "lycee-2019-1re-algebra", "arithmetic_sequence", ("sequences",), ("reasoning",), (2, 3)),
    Family("1re-derivative-polynomial", "Dériver une fonction polynomiale", "premiere", "lycee-2019-1re-analysis", "derivative", ("derivatives",), ("calculation",), (2, 3)),
    Family("1re-derivative-extremum", "Étudier un extremum par la dérivée", "premiere", "lycee-2019-1re-analysis", "derivative_extremum", ("derivatives",), ("optimization",), (3, 4)),
    Family("1re-vector-collinearity", "Démontrer la colinéarité de vecteurs", "premiere", "lycee-2019-1re-geometry", "collinearity", ("geometry",), ("proof",), (2, 3)),
    Family("1re-probability-tree", "Calculer une probabilité conditionnelle", "premiere", "lycee-2019-1re-probability", "conditional", ("probability",), ("reasoning",), (2, 4)),
