...
def test_health_reports_database_and_corpus(monkeypatch):
    ...
    assert body == {'status':'ok','service':'khollelab-api','database':'ok','problem_corpus':'ok','problem_count':70,'resource_corpus':'ok','resource_count':15,'curriculum_levels':7,'inference':'disabled'}
